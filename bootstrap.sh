...
#FILE_SYSTEM_ID
FILE_SYSTEM_ID=fs-00e1799246775e747
...
sudo git clone https://github.com/IJMAN1969/Pre-Clixx-Deployment.git
...
mysql -h wordpressinstance.c5kermpcltat.us-east-1.rds.amazonaws.com -u admin -pchelsea1234$<<EOF
use wordpressdb;
UPDATE wp_options SET option_value = "stack-LB-484095159.us-east-1.elb.amazonaws.com" WHERE option_value LIKE 'http%';
EOF